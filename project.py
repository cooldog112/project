...
image1 = tkinter.PhotoImage(file='짜장면.png')
image2 = tkinter.PhotoImage(file='짬뽕.png')
image3 = tkinter.PhotoImage(file='볶음밥.png')
...
cv1 = tkinter.IntVar()
ckb1 = tkinter.Checkbutton(window, text='5000원',
                           variable=cv1, command=func1)
cv2 = tkinter.IntVar()
ckb2 = tkinter.Checkbutton(window, text='6000원',
                           variable=cv2, command=func1)
cv3 = tkinter.IntVar()
ckb3 = tkinter.Checkbutton(window, text='7000원',
                           variable=cv3, command=func1)
cv4 = tkinter.IntVar()
ckb4 = tkinter.Checkbutton(window, text='12000원',
                           variable=cv4, command=func1)
